...
class AttendanceNo extends React.Component {
                ...
                <View style={{justifyContent:'center',borderWidth:0,width:width*0.7,alignSelf:'center',marginBottom:120}}>
                    ...
                    <View style={{borderWidth:0,marginTop:0,alignItems:'center'}}>
                        ...
                        <Text style={{fontSize:14,paddingVertical:10}}>{this.state.date}</Text>
                          ...
                          <Text style={{fontSize:16,paddingVertical:10,textAlign:'center'}}>You have marked yourself to leave today</Text>
                          <Text style={{fontSize:16,paddingVertical:10}}>Are you sure?</Text>
                    </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(AttendanceNo);
