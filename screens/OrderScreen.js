  ...
  constructor(props) {
    ...
    this.state = {
        ...
        like: 23,
         ...
         likeActive: false,
         dislikeActive: false,
         prod:[{date:'Date:12-07-2020',name:'Safa Super Market',ite:'items:22',value:'value:20,000'},
              {date:'Date:12-07-2020',name:'Kundan Electronics',ite:'items:22',value:'value:20,000'},
              {date:'Date:12-07-2020',name:'More Market',ite:'items:22',value:'value:20,000'},
              {date:'Date:12-07-2020',name:'Retailers name',ite:'items:22',value:'value:20,000'},
              {date:'Date:12-07-2020',name:'Safa Super Market',ite:'items:22',value:'value:20,000'},
              {date:'Date:12-07-2020',name:'Safa Super Market',ite:'items:22',value:'value:20,000'}]
    }
          ...
          <View  style={{justifyContent:'center',backgroundColor:'#fff',borderWidth:0,
            height:55,width:width}}>
              ...
              <TouchableOpacity onPress={()=>{this.props.navigation.goBack();}}>
                ...
                <Text style={{fontSize:20,color:'#fff',alignItems:'center',paddingTop:10,paddingBottom:6}}>Order</Text>
          ...
          <ScrollView style={{marginVertical:0,backgroundColor:'#CECECF',paddingBottom:100}}>
            <FlatList
                ...
                <TouchableOpacity style={{flex:1,
                    ...
                    <View style={{paddingVertical:10,paddingHorizontal:10,borderWidth:0,width:width*0.85}}>
                        <View style={{flexDirection:'row',justifyContent:'space-between',paddingBottom:4}}>
                            <Text style={{fontSize:18,color:'#000'}}>{item.name}</Text>
                            <Text style={{fontSize:14,color:'#000'}}>{item.date}</Text>
                        </View>
                        <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                            <Text style={{fontSize:14,color:'#000'}}>{item.ite}</Text>
