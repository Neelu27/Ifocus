...
class CovidSurvey extends React.Component {
    ...
    return (
      <View style={{flex:1}}>
          ...
          <View  style={{justifyContent:'space-between',backgroundColor:'#fff',borderBottomWidth:0.5,
            height:55,width:width,flexDirection:'row',alignItems:'center'}}>
              ...
              <TouchableOpacity onPress={()=>{this.props.navigation.goBack();}}>
                ...
                <Text style={{fontSize:20,color:'#000',alignItems:'center',paddingTop:10,paddingBottom:6,marginRight:width*0.7}}>Covid Survey</Text>
          ...
          <View style={{paddingVertical:10,paddingHorizontal:15}}>
            ...
            <Text style={{fontSize:18,marginVertical:6}}>Do you feel any symptums of corona?</Text>
            <TextInput style={{backgroundColor:'#ffffff',
                              borderRadius:7,
                              paddingHorizontal:0,
                              paddingVertical:10,
...
export default connect(mapStateToProps, mapDispatchToProps)(CovidSurvey);
