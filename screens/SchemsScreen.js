...
class SchemsScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
        ...
        like: 23,
         ...
         likeActive: false,
         dislikeActive: false,
         prod:[{code:'SC001',date:'Till 30 march 2020',nam:'Buy 1 get 1 free',name:'A prototype is an early sample, model, or release of a product built to test a concept or process.'},
              {code:'SC001',date:'Till 30 march 2020',nam:'Buy for 50,000,get one watch free',name:'A prototype is an early sample, model, or release of a product built to test a concept or process.'},
              {code:'SC001',date:'Till 30 march 2020',nam:'Buy 1 get 1 free',name:'A prototype is an early sample, model, or release of a product built to test a concept or process.'},
              {code:'SC001',date:'Till 30 march 2020',nam:'Buy fo 50,000,get one watch free',name:'A prototype is an early sample, model, or release of a product built to test a concept or process.'},
              {code:'SC001',date:'Till 30 march 2020',nam:'Buy 1 get 1 free',name:'A prototype is an early sample, model, or release of a product built to test a concept or process.'},
              {code:'SC001',date:'Till 30 march 2020',nam:'Buy fo 50,000,get one watch free',name:'A prototype is an early sample, model, or release of a product built to test a concept or process.'}]
    }
          ...
          <View  style={{justifyContent:'center',backgroundColor:'#fff',borderWidth:0,
            height:55,width:width}}>
              ...
              <TouchableOpacity onPress={()=>{this.props.navigation.goBack();}}>
                ...
                <Text style={{fontSize:20,color:'#fff',alignItems:'center',paddingTop:10,paddingBottom:6}}>Safa Super Market11</Text>
          ...
          <ScrollView style={{marginVertical:0,backgroundColor:'#CECECF',paddingBottom:100}}>
            <FlatList
                ...
                <View style={{flex:1,
                    ...
                    <View style={{paddingVertical:10,paddingHorizontal:10,alignSelf:'center'}}>
                        <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                            <Text style={{fontSize:14,color:'#000'}}>{item.code}</Text>
                            <Text style={{fontSize:14,color:'red'}}>{item.date}</Text>
                        </View>
                        <Text style={{fontSize:14,color:'red',}}>{item.nam}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(SchemsScreen);
