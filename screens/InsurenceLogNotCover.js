...
export default class InsurenceLogNotCover extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            limit:10,
            count:0,
            prod:[{uri:require('../assets/ifocus/NaturopathyTreatment.png'),name:'Naturopathy treatment ',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/DentalTreatment.png'),name:'Dental treatment',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/AilementTreatment.png'),name:'Ailement Treatment',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/GlassessAids.png'),name:'Glasses & Aids',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/NaturopathyTreatment.png'),name:'Naturopathy treatment',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/DentalTreatment.png'),name:'Dental treatment',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/AilementTreatment.png'),name:'Ailement Treatment ',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/GlassessAids.png'),name:'Glasses & Aids',itemav:'Not covered'},
                  {uri:require('../assets/ifocus/NaturopathyTreatment.png'),name:'Naturopathy treatment',itemav:'Not covered'},
