...
class SenitizerScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
        ...
        like: 23,
         ...
         likeActive: false,
         dislikeActive: false,
         prod:[{uri:require('../assets/ifocus/cart_himalayan.png'),name:'Himalayan handwash'},
               {uri:require('../assets/ifocus/thermom.png'),name:'A digital Thermometers'},
               {uri:require('../assets/ifocus/masks.png'),name:'Masks'},
               {uri:require('../assets/ifocus/faceshield.png'),name:'Faceshield'},
               {uri:require('../assets/ifocus/cart_himalayan.png'),name:'Himalayan handwash'},
               {uri:require('../assets/ifocus/thermom.png'),name:'A digital Thermometers'},
                {uri:require('../assets/ifocus/masks.png'),name:'Masks'},
                {uri:require('../assets/ifocus/faceshield.png'),name:'Faceshield'},
                {uri:require('../assets/ifocus/cart_himalayan.png'),name:'Himalayan handwash'},
    ...
    return (
      <View style={{flex:1}}>
          ...
          <View  style={{justifyContent:'space-between',backgroundColor:'#fff',borderBottomWidth:0.5,
              ...
              <Text style={{fontSize:18,marginRight:width*0.28}}>{prod.name}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(SenitizerScreen);
