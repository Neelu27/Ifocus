             ...
             <TouchableOpacity style={{flex:1,borderWidth:1,borderColor:'#C7C7C7',width:width*0.95,backgroundColor:'#fff',paddingHorizontal:10,paddingTop:8,marginVertical:8,marginHorizontal:10}}
               ...
               <TouchableOpacity  onPress={()=>{this.props.navigation.navigate('Checkout',{add:true});}} >
                   ...
                   <View style={{borderWidth:0,justifyContent:'space-between',flexDirection:'row',marginVertical:10}}>
                      ...
                      <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}}><FontAwesome name={'edit'} size={16}/><Text>Edit</Text></TouchableOpacity>
                      <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}}><FontAwesome name={'trash-o'} size={16}/><Text>Delete</Text></TouchableOpacity>
                   </View>
