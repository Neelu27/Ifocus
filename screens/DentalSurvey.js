...
class DentalSurvey extends React.Component {
    ...
    return (
      <View style={{flex:1}}>
          ...
          <View  style={{justifyContent:'space-between',backgroundColor:'#fff',borderBottomWidth:0.5,
            height:55,width:width,flexDirection:'row',alignItems:'center'}}>
              ...
              <TouchableOpacity onPress={()=>{this.props.navigation.goBack();}}>
                ...
                <Text style={{fontSize:20,color:'#000',alignItems:'center',paddingTop:10,paddingBottom:6,marginRight:width*0.4}}>Dental Care Survey</Text>
          ...
          <ScrollView style={{paddingVertical:10,paddingHorizontal:15}}>
            ...
            <Text style={{fontSize:18,marginVertical:6}}>How much times in a month you visit the Doctor?</Text>
            <TextInput style={{backgroundColor:'#ffffff',
                              borderRadius:7,
                              paddingHorizontal:0,
                              paddingVertical:10,
            ...
            <Text style={{fontSize:18,marginVertical:6}}>The most common reason to go to the Doctor?</Text>
            <TextInput style={{backgroundColor:'#ffffff',
                              borderRadius:7,
                              paddingHorizontal:0,
                              paddingVertical:10,
...
export default connect(mapStateToProps, mapDispatchToProps)(DentalSurvey);
