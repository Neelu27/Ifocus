...
class CoughcoldScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
        ...
        like: 23,
         ...
         likeActive: false,
         dislikeActive: false,
         prod:[{uri:require('../assets/ifocus/Cofsils.png'),name:'Cofsils 10 Tablets'},
               {uri:require('../assets/ifocus/vicks.png'),name:'Vicks Vapourrub'},
               {uri:require('../assets/ifocus/benadryl.png'),name:'Benadryl Syrup'},
               {uri:require('../assets/ifocus/hevertcoughrelief.png'),name:'Hevert Cough Tablets'},
               {uri:require('../assets/ifocus/Cofsils.png'),name:'Cofsils 10 Tablets'},
               {uri:require('../assets/ifocus/vicks.png'),name:'Vicks Vapourrub'},
                {uri:require('../assets/ifocus/benadryl.png'),name:'Benadryl Syrup'},
                {uri:require('../assets/ifocus/hevertcoughrelief.png'),name:'Hevert Cough Tablets'},
                {uri:require('../assets/ifocus/Cofsils.png'),name:'Cofsils 10 Tablets'},
...
export default connect(mapStateToProps, mapDispatchToProps)(CoughcoldScreen);
