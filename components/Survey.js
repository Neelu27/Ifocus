...
class Survey extends React.Component {
    ...
    this.state = {
        ...
        like: 23,
         ...
         prod:[{uri:require('../assets/ifocus/survey_covid.png'),name:'covid survey'},
               {uri:require('../assets/ifocus/surveyoverallhealth.png'),name:'survey overall health'},
               {uri:require('../assets/ifocus/survey_skincareconsultant.png'),name:'survey_skin care consultant'},
               {uri:require('../assets/ifocus/Survey_primarytrauma.png'),name:'Survey primary trauma'},
               {uri:require('../assets/ifocus/survey_dentalcare.png'),name:'survey dental care'},
               {uri:require('../assets/ifocus/survey_Healthinsurance.png'),name:'survey_Health insurance'},
               {uri:require('../assets/ifocus/Survey_oralhealth.png'),name:'Survey_oral health'},
                          ],
    }
  ...
  next=(item)=>{
    ...
    else if(item.name=='survey overall health'){
      this.props.navigation.navigate('SurveyHealthScreen',{item:item});
    }
    else if(item.name=='survey dental care'){
